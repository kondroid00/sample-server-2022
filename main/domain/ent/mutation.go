...
func (m *UserMutation) SetEmail(ss sql.NullString) {
	m.email = &ss
}

// Email returns the value of the "email" field in the mutation.
func (m *UserMutation) Email() (r sql.NullString, exists bool) {
	v := m.email
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldEmail(ctx context.Context) (v sql.NullString, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *UserMutation) SetState(ss schema.UserState) {
	m.state = &ss
}

// State returns the value of the "state" field in the mutation.
func (m *UserMutation) State() (r schema.UserState, exists bool) {
	v := m.state
	if v == nil {
		return
	}
...
// If the User object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserMutation) OldState(ctx context.Context) (v schema.UserState, err error) {
	if !m.op.Is(OpUpdateOne) {
