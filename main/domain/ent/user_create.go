...
func (uc *UserCreate) SetEmail(ss sql.NullString) *UserCreate {
	uc.mutation.SetEmail(ss)
	return uc
}

// SetNillableEmail sets the "email" field if the given value is not nil.
func (uc *UserCreate) SetNillableEmail(ss *sql.NullString) *UserCreate {
	if ss != nil {
		uc.SetEmail(*ss)
	}
	return uc
...
func (uc *UserCreate) SetState(ss schema.UserState) *UserCreate {
	uc.mutation.SetState(ss)
	return uc
}
